...
koaRouter.post('/doFollow/:name', authService.authenticated(), controller.doFollow)
koaRouter.post('/undoFollow/:name', authService.authenticated(), controller.undoFollow)
